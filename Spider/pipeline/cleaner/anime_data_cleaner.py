...
INPUT_FILE = os.path.join(SCRIPT_DIR, "..", "raw", "动漫信息_v2.json")
OUTPUT_JSONL = os.path.join(SCRIPT_DIR, "..", "..", "rawdata", "data", "anime_cleaned.jsonl")
OUTPUT_CSV = os.path.join(SCRIPT_DIR, "..", "..", "rawdata", "data", "anime_cleaned.csv")
REPORT_FILE = os.path.join(SCRIPT_DIR, "..", "..", "rawdata", "data", "cleaning_report.json")
