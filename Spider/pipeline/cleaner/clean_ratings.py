...
RATINGS_FILE = os.path.join(SCRIPT_DIR, "..", "raw", "user_ratings.jsonl")   # 输入: 爬虫产物
CSV_FILE = os.path.join(SCRIPT_DIR, "..", "..", "rawdata", "data", "anime_cleaned.csv")        # 输入: 动漫表
OUTPUT_CSV = os.path.join(SCRIPT_DIR, "..", "..", "rawdata", "data", "user_ratings.csv")       # 输出: 清洗后的标准评分
REPORT_FILE = os.path.join(SCRIPT_DIR, "..", "..", "rawdata", "data", "cleaning_report.json")  # 输出: 报告
