...
CSV_FILE = os.path.join(SCRIPT_DIR, "..", "..", "rawdata", "data", "anime_cleaned.csv")        # 输入: 已有动漫数据
COLLECTED_USERS_FILE = os.path.join(SCRIPT_DIR, "..", "raw", "user_pool.json")       # 引导层产物: 用户名池
RATINGS_FILE = os.path.join(SCRIPT_DIR, "..", "raw", "user_ratings.jsonl")       # 数据层产物: 评分数据
PROGRESS_FILE = os.path.join(SCRIPT_DIR, "..", "raw", "user_spider_progress.json") # 断点续爬进度
