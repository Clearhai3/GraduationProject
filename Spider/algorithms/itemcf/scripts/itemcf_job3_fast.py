...
# ItemCF 产物舱 (sim 输入 / rec 输出) + 公共评分区 (train_ratings)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DATA_DIR = os.path.join(BASE_DIR, "..", "data")
SIM_FILE = os.path.join(DATA_DIR, "itemcf_sim_train.txt")            # Job2 输出
REC_FILE = os.path.join(DATA_DIR, "itemcf_rec_train.txt")            # 本 Job 输出
RATINGS_FILE = os.path.join(BASE_DIR, "..", "..", "..", "rawdata", "data", "train_ratings.csv")  # 公共数据
...
def main():
    # 读文件
    out = open(REC_FILE, 'w', encoding = 'utf-8')
