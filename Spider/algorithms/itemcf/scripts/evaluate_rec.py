...
TEST_FILE = os.path.join(SCRIPT_DIR, "..", "..", "..", "rawdata", "data", "test_ratings.csv")   # 测试集 (公共区)
REC_FILE = os.path.join(SCRIPT_DIR, "..", "data", "itemcf_rec_train.txt")       # 推荐结果 (本舱 data/)
REPORT_FILE = os.path.join(SCRIPT_DIR, "..", "data", "evaluation_report.json")  # 报告 (本舱 data/)
