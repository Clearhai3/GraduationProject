...
RATINGS_FILE = os.path.join(SCRIPT_DIR, "..", "data", "user_ratings.csv")     # 输入
TRAIN_FILE = os.path.join(SCRIPT_DIR, "..", "data", "train_ratings.csv")      # 输出: 训练集
TEST_FILE = os.path.join(SCRIPT_DIR, "..", "data", "test_ratings.csv")        # 输出: 测试集
