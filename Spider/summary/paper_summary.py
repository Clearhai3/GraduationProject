...
CLEAN_REPORT = os.path.join(SCRIPT_DIR, "..", "rawdata", "data", "cleaning_report.json")     # 清洗报告
ANIME_CSV = os.path.join(SCRIPT_DIR, "..", "rawdata", "data", "anime_cleaned.csv")           # 动漫表
EVAL_REPORT = os.path.join(SCRIPT_DIR, "..", "algorithms", "itemcf", "data", "evaluation_report.json")    # 评估报告
